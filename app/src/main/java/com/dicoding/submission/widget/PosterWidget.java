...
public class PosterWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.dicoding.submission.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.dicoding.submission.EXTRA_ITEM";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        toastIntent.setAction(PosterWidget.TOAST_ACTION);
